...
<div class="services-top-breadcrumbs">
	<div class="container">
		<div class="services-top-breadcrumbs-right">
			<ul>
				<li><a href="<?php echo site_url()?>">Inicio</a> <i>/</i></li>
                <li><a href="<?php echo site_url('rooms')?>">Habitaciones</a> <i>/</i></li>
            				...
            				<div class="reservation-grid-left">
            					<div class="section_room">
            						...
            						<select name="adults" id="country2" onchange="change_country(this.value)" class="frm-field required" title="Adults">
                                        <option hidden="hidden">Los adultos</option>
            				...
            				<div class="reservation-grid-right">
            					<div class="section_room">
            						...
            						<select name="kids" id="country3" onchange="change_country(this.value)" class="frm-field required">
                                        <option value="0" hidden="hidden">Niños</option>
