                                ...
                                <?php if(count($this->front_user)>0):?>
                    				<li class="dropdown">
                    					...
                    					<ul class="dropdown-menu">
                    							 ...
                    							 <li ><a  href="<?php echo site_url('front/account/profile')?>" > <i class="fa fa-user pull-left" class=""></i> <?php echo lang('profile')?></a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header header-panal">
        ...
        <h4 class="modal-title" style="color:#000"><?php echo lang('login')?></h4>
      </div>
...
<div id="cs-signup" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header header-panal" >
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" style="color:#000"><?php echo lang('signup')?></h4>
      </div>
      <div class="modal-body">
...
<div id="cs-forgot" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header header-panal">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" style="color:#000"><?php echo lang('i_forgot_my_password')?></h4>
      </div>
      <div class="modal-body">
