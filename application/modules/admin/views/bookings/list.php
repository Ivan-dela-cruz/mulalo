					...
					<form method="post" id="filterForm">
						<div class="form-group">
						  <div class="row">
							...
							<div class="col-md-2">
								<input type="text" name="check_in" value="<?php echo @$_POST['check_in']?>" class="form-control datepicker"  placeholder='<?php echo lang('check_in');?>' autocomplete="off" />
							</div>
							<div class="col-md-2">
								<input type="text" name="check_out" value="<?php echo @$_POST['check_out']?>" class="form-control datepicker"  placeholder='<?php echo lang('check_out');?>' autocomplete="off" />
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-1">
								<input type="text" name="ordered_on" value="<?php echo @$_POST['ordered_on']?>" class="form-control datepicker"  placeholder='<?php echo lang('booking_date');?>' autocomplete="off" />
							</div>
							<div class="col-md-1">
								<input type="submit" name="sub" class="btn btn-primary" value="Get" />
							</div>
						  </div>		
						</div>
					</form>	
						...
						<?php $i=1;foreach ($bookings as $new):?>
								<tr>
                                    ...
                                    <td id="<?php echo $new->id?>"><a class="btn btn-danger" href="<?php echo site_url('admin/bookings/delete/'.$new->id);?>">Eliminar</a></td>
